...
var _OIPRecord = _interopRequireDefault(require("./OIPRecord"));
...
class Publisher extends _OIPRecord.default {
  ...
  setVerification(type, verification_url) {
    ...
    if (typeof verification_url !== "string") throw new Error("Verification URL must be a string!"); // Test if verification type is allowed
  ...
  getVerification(type) {
    if (typeof type !== "string") throw new Error("Verification Type must be a string!"); // Test if verification type is allowed
